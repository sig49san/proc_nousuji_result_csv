...
HISTORY_COLUMNS = ['submission_date','submission_time','UserName','TwitterID','score','Left','Right','FLIP','LEGACY','A-SCR','play_format','clear_award']
...
def process_ranking(input_file, manual_file=None):
    ...
    if manual_file is None:
        manual_file = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'input', 'manual_users.csv')
